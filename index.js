...
function openModal(e) {
  ...
  const computedStyle = window.getComputedStyle(clickedProject);
  const imageUrl = computedStyle.backgroundImage.replace(/url\("|"\)/g, ''); // Extrae la URL de la imagen del estilo del proyecto clicado
  const modalImage = document.querySelector(".modal-project-image");

  // Actualiza el fondo del modal con la URL de la imagen del proyecto clicado
